...
const HEADERS: HeaderPatterns = {
  "/.*": {
    ...
    "Content-Security-Policy":
      "default-src 'self'; script-src-elem 'self' https://talk.hyvor.com; connect-src 'self' wss: https://*.hyvor.com https://tinylog-bot.lark.gay; img-src 'self' https:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; frame-ancestors 'none';",
